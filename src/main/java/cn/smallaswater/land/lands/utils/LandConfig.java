...
public class  LandConfig {
    ...
    public static LandConfig getLandConfig(){
        ...
        landConfig.setLanguage(config.getString("language", "chs"));
        landConfig.setShowTime(config.getInt("售卖领地显示时间",7));
        landConfig.setLandTool(Item.fromString(config.getString("landTool","290:0")));
